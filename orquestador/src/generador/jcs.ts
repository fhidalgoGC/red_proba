 ...
 *
 * ESTA PIEZA ES COMPARTIDA CON C3. El ajuste a 3.072 bytes se hace aqui, en
 * el orquestador; la firma se hace alla, en C3. Si cada lado canoniza con una
 * implementacion distinta, el tamaño no cuadra y la firma no verifica. Cuando
 * C3 exista de verdad, este archivo se mueve a un paquete compartido — no se
 * copia.
 *
